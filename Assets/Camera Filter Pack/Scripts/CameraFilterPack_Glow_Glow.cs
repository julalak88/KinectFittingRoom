...
DestroyImmediate(SCMaterial);	
    ...
    public void StartDistort(bool value) {
        _enabled = value;
        enabled = true;
        Intensity = 0;
        DOVirtual.Float(0, 1, 1f, onValueUpdate).OnComplete(tweenComplete1);
    }

    private void tweenComplete1() {
        DOVirtual.Float(1, 0.2f, 2f, onValueUpdate).OnComplete(tweenComplete2);
    }

    private void tweenComplete2() {
        enabled = _enabled;
    }
